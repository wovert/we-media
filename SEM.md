...
> 为达到最优的投放效果，将**关键词**和**创意**等按搜素引擎推广账户的规则进行归纳和整理，从而形成有序结构
...
![百度推广账户结构图](./images/bd-account-structure.png)

![举例](./images/tg-plan.png)

#### 推广计划

> 管理一系列关键词/创意的大单位，是推广账户内最高的层级设置，通过推广计划的使用，可以根据产品的特性或个人习惯等更好地管理推广项目

#### 推广单元

> 管理一系列关键词、创意的小单位、每个推广单元下有多个关键词共享多个创意，形成关键词和创意的多对多

#### 创意

> 网民搜索触发商户的推广结果时，展现在网民面前的推广信息，包括一行标题、两行描述、以及访问URL和显示URL

![创意例子](./images/creative.png)
